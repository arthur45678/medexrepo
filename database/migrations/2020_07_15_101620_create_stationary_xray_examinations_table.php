...
class CreateStationaryXrayExaminationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stationary_xray_examinations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('stationary_xray_examinations');
    }
}
