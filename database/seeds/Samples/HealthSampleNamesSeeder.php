...
class HealthSampleNamesSeeder extends Seeder
{

    /**
     * list of health samples, size with stationary and ambulator=50
     */
    private $samples = [
        'stationaries' => [
            'name' => 'Ստացիոնար քարտ',
    ...
    public function run()
    {
        foreach ($this->samples as $sample) {
            HealthSampleName::create($sample);
        }
    }
}
