...
class OrderInputForCahhboxSecondController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cashbox.cashboxSecond.index',compact('patients','doctors','ordersInput','orderOutput','correspondentaccount'));
    }
    ...
    public function show($id)
    {
        ...
        return view('cashbox.cashboxSecond.orderinput.show',compact('order'));
    }
    ...
    {
        $order = Order::findOrFail($id);
        return view('cashbox.cashboxSecond.orderinput.edit',compact('order'));
    }
