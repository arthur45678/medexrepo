...
class OrderInputForCahhboxFirstController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cashbox.cashboxFirst.index',compact('patients','doctors','ordersInput','orderOutput','correspondentaccount'));
    }
...
//        return response()->json(['success'=>'Մուտքի օրդերը ավելացվել է']);
    ...
    public function show($id)
    {
        ...
        return view('cashbox.cashboxFirst.orderinput.show',compact('order'));
    }
    ...
    {
        $order = Order::findOrFail($id);
        return view('cashbox.cashboxFirst.orderinput.edit',compact('order'));
    }
