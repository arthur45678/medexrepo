...
class OrderOutputForCahhboxThirthController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cashbox.cashboxThirth.index',compact('patients','doctors','orders'));
    }
...
//        $data = $request->all();
    ...
    public function show($id)
    {
        ...
        return view('cashbox.cashboxThirth.orderoutput.show',compact('order'));
    }
    ...
    {
        $order = OrderOutput::findOrFail($id);
        return view('cashbox.cashboxThirth.orderoutput.edit',compact('order'));
    }
