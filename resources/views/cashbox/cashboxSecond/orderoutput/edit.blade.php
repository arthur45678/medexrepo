...
@section('card-content')
    ...
    <form method="post" action="{{ route('cashbox.cashboxSecond.orderoutput.update',$order->id) }}">
        @csrf
        @method('put')
        ...
        <div class="form-group">
            ...
            <input  type="text" name="passport_data" id="#" value="{{ $order->passport_data }}" class="form-control">
        </div>
        <div class="form-group">
