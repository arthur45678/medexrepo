    ...
    <ul class="nav nav-tabs nav-underline nav-underline-primary" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#messages" role="tab" aria-selected="false">
                <x-svg icon="cui-speech" />
            </a>
        </li>
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#settings" role="tab" aria-selected="false">
            ...
            <div class="list-group list-group-accent">
                ...
                <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                    ...
                    <div>Meeting with <strong>Lucas</strong></div><small class="text-muted mr-3">
                        <x-svg icon="cui-calendar" />&nbsp; 1 - 3pm</small><small class="text-muted">
                        <x-svg icon="cui-location-pin" />&nbsp; Palo Alto, CA</small>
                </div>
                <div class="list-group-item list-group-item-accent-info">
                    ...
                    <div>Skype with <strong>Megan</strong></div><small class="text-muted mr-3">
                        <x-svg icon="cui-calendar" />&nbsp; 4 - 5pm</small><small class="text-muted">
                        <x-svg icon="cui-skype" />&nbsp; On-line</small>
                </div>
                <div
                    class="list-group-item list-group-item-accent-secondary bg-light text-center font-weight-bold text-muted text-uppercase c-small">
                    Tomorrow</div>
                <div class="list-group-item list-group-item-accent-danger list-group-item-divider">
                    <div>New UI Project - <strong>deadline</strong></div><small class="text-muted mr-3">
                        <x-svg icon="cui-calendar" />&nbsp; 10 - 11pm</small><small class="text-muted">
                        <x-svg icon="cui-home" />&nbsp; creativeLabs HQ</small>
                    <div class="c-avatars-stack mt-2">
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/2.jpg')}}"
                                alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/3.jpg')}}"
                                alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/4.jpg')}}"
                                alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/5.jpg')}}"
                                alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/6.jpg')}}"
                                alt="user@email.com"></div>
                    </div>
                </div>
                ...
                <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                    <div><strong>Team meeting</strong></div><small class="text-muted mr-3">
                        <x-svg icon="cui-calendar" />&nbsp; 4 - 6pm</small><small class="text-muted">
                        <x-svg icon="cui-home" />&nbsp; creativeLabs HQ</small>
                    <div class="c-avatars-stack mt-2">
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/2.jpg')}}"
                                alt="user@email.com"></div>
                        ...
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/6.jpg')}}"
                                alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/7.jpg')}}"
                                alt="user@email.com"></div>
                        <div class="c-avatar c-avatar-xs"><img class="c-avatar-img" src="{{asset('assets/img/avatars/8.jpg')}}"
                                alt="user@email.com"></div>
                    </div>
                </div>
            </div>
