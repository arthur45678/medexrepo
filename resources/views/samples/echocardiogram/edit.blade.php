...
<div class="container">
    ...
    <form class="ajax-submitable dont-reset" action="{{ route('samples.patients.echocardiogram.update', ['patient'=> $patient,  $post->id]) }}" method="POST">
        @csrf
        @method('put')
        <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    value="{{ $post->diastolic_size_KDR }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->diastolic_size_KCR }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->diastolic_size_KDO }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->diastolic_size_KCO }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                ...
                <li class="list-group-item">
                    ...
                    value="{{ $post->interventricular_septum }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->extraction_fraction }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    <div class="text-center">
                    ...
                    value="{{ $post->AP_diastolic_size }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->AP_wall_norma }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->aortic_roo_diameter }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->left_atrium_diameter }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->small_size_of_the_left_atrium }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
                    ...
                    value="{{ $post->the_size_of_the_lower_window }}" label="" />
                    </div>
                </li>
                <li class="list-group-item">
