...
<div class="container">
    <form class="ajax-submitable" action="{{route('samples.patients.xray-examination-log.store', ['patient'=> $patient])}}" method="POST">
        @csrf
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="form-row align-items-center">
                    ...
                    <div class="col-md-6">
                            <x-forms.text-field name="reg_date" label="" type="date" validationType="ajax" />
                            {{-- @error('reg_date')
                            <em class="error text-danger">Ամսաթիվ դաշտը պարտադիր է։</em>
                            @enderror --}}
