...
<div class="container">
    <form class="ajax-submitable" action="{{route('samples.patients.biochemical-lab-n7.update', ['patient'=> $patient, $bl->id])}}" method="POST">
        @csrf
        @method('put')
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->prothrombin_time}}" label="Պրոթրոմբինային ժամանակ /PT/  նորմա - 12`-16`" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->prothrombin_index}}" label="Պրոթրոմբինային ինդեքս /iPT/ նորմա - 180-105 %" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->plasma_tolerance}}" label="Պլազմայի տոլերանտությունը հեպարինի նկատմամբ նորմա - 3-6 րոպե" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->fibrinogen}}" label="Ֆիբրինոգեն /FG/ նորմա - 2-4 գ/լ" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->fibrinogen_b}}" label="Ֆիբրինոգեն «Բ» /FG «B» նորմա - ( - )" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->normalized_international}}" label="Միջազգային նորմալիզացված հարաբերություն /INR/ նորմա - 1-1,8" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->active_thromboplastin}}" label="Ակտիվ մասնակի տրոմբոպլաստինային ժամանակ /APTT/ նորմա - 25`-35`" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->thrombin_time}}" label="Թրոմբինային ժամանակ /TT/ նորմա - 15`-20`" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{$bl->ddimer}}" label="Դդիմեր /D-dimer/ նորմա - < 250 մկգ/լ" />
                </div>
            </li>
