...
<div class="container">
    <form  action="{{route('samples.patients.iep-n4.update',[$immunologia->id,$patent->id])}}" method="POST" class="ajax-submitable">
        @csrf
        @method('put')
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="TTG" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->TTG}}" label="TTG /Թիրեոտրոպին/ - Նորմա - 0,27-4,2_մIՍ/mL" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="T3" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->T3}}" label="T3 /Եռյոդթիրոնին ընդհանուր/ - Նորմա - 1,2-3,16__պկմ/լ" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="F_T3" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->F_T3}}" label="F T3 /Եռյոդթիրոնին ազատ/ - Նորմա - 4,4-9,3 պկմ/լ" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="T4" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->T4}}" label="T4 /Թիրոքսին ընդհանուր/ - Նորմա - 60-165 նմ/լ" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="F_T4" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->F_T4}}" label="F T4 /Թիրոքսին ազատ/ - Նորմա - 10-24 պկմ/լ" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="TG" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->TG}}" label="TG /Թիրեոգլոբուլին/ - Նորմա - 0-50նգ/մլ" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="Aոti_TG" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->Aոti_TG}}" label="Aոti TG /հակաթիրեոգլոբուլին հակամարմիններ/ - Նորմա - 0-40 մմ/մլ" />
                </div>
            </li>
            <li class="list-group-item">
                <strong>Aոti TPO /հակաթիրեոիդպերօքսիդազ հակամարմիններ/ - Նորմա - &#60;35մմ/մլ</strong>
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="Aոti_TPO" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->Aոti_TPO}}" label="" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="CTN" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->CTN}}" label="CTN /Կալցիտոնին/ - Նորմա - 5,5-28 պկմ/լլ" />
                </div>
            </li>
            <li class="list-group-item">
                <strong>PTH /պարատ հորմոն/ - Նորմա - 15,0-65,0 պգ/մլ</strong>
                <div class="mt-2">
                    <x-forms.text-field type="textarea" name="PTH" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                                        value="{{$immunologia->PTH}}" label="" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="form-row align-items-center">
