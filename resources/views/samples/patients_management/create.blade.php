        ...
        <ul class="list-group">
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="mode_v" id="height" value="" min="1" max="24" label=""/>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="patient_v_cxp" id="	patient_v_cxp" value="" min="1" max="24" label=""/>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="fq" id="fq" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="patient_fq" id="patient_fq" value="" min="1" max="24" label=""/>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="fiO2_peep" id="fiO2_peep" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="ps_respiratory_assistance" id="height" value="" min="1" max="24" label=""/>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="in_the_airways_saO2" id="height" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="artery_pressure" id="artery_pressure" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="central_vein_pressure" id="central_vein_pressure" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="pulse" id="pulse" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="temperature" id="temperature" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="dihurez" id="dihurez" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="drainages" id="drainages" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <x-forms.text-field type="number" class="col-4" name="imported_liquid_ml" id="imported_liquid_ml" value="" min="1" max="24" label=""/>
                                <label class="ml-2" for="height"><strong></strong></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="stationary-prescription-row {{ $i < old('prescription_length', 1) ? ' ' : 'd-none' }}">
                            ...
                            <div class="mb-2">
                                <x-forms.magic-search class="medicines-search magic-search ajax"
                                                      ...
                                                      hidden-id="medicinelists_id_id{{ $i }}" hidden-name="medicinelists_id[]"
