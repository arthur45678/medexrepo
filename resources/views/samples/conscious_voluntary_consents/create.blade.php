...
<div class="container">
    <form class="ajax-submitable" action="{{ route('samples.patients.conscious-voluntary-consents.store', ['patient'=> $patient]) }}" method="POST">
        @csrf
        <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <div class="my-2">
                        <x-forms.magic-search class="magic-search ajax" value='' hidden-id="medicine_id"
                ...
                <li class="list-group-item">
                    ...
                    <select name="payment_type" id="payment_type_id" class="form-control my-2">
                                <option value="paid">Վճարովի</option>
                                <option value="state_order">Պետպատվեր</option>
                                <option value="social_insurance">Սոց․ ապահովագրություն</option>
                                <option value="co_payment">Համավճար</option>
                    </select>
                </li>
                <li class="list-group-item">
