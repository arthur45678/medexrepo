...
<div class="container">
    <form class="ajax-submitable" action="{{route('samples.patients.biochemical-lab-n3.store', ['patient'=> $patient])}}" method="POST">
        @csrf
        <ul class="list-group">
