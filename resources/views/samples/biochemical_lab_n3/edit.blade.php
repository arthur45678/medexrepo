...
<div class="text-center">
    <h3>ԿԵՆՍԱՔԻՄԻԱԿԱՆ ԼԱԲՈՐԱՏՈՐԻԱ ԲԺՇԿԱԿԱՆ ՁԵՎ N 3</span></h3>
</div>
@endsection
...
<div class="container">
    <form class="ajax-submitable" action="{{route('samples.patients.biochemical-lab-n3.update', ['patient'=> $patient, $bl->id])}}" method="POST">
        @csrf
        @method('put')
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="number" step="0.1" name="albumin" validationType="ajax" placeholder="լրացրեք համապատասխան թիվը․․․"
                     value="{{$bl->albumin}}" label="Ընդհանուր սպիտակուց նորմա - 65.0 – 85.0 գ/լ" />
                </div>
            </li>
            <li class="list-group-item">
                <div class="mt-2">
                    <x-forms.text-field type="number" step="0.1" name="common_protein" validationType="ajax" placeholder="լրացրեք համապատասխան թիվը․․․"
                    value="{{$bl->common_protein}}" label="Ալբումին նորմա - 35.0 – 50.0 գ/լ" />
                </div>
            </li>
