...
<div class="container">
    <form class="ajax-submitable" action="{{ route('samples.patients.drug-destruction-act.update', ['patient'=> $patient,  $post->id]) }}" method="POST">
        @csrf
        @method('put')
        <ul class="list-group">
            ...
            <li class="list-group-item">
                ...
                placeholder="Ընտրել ուղեգրող բժիշկին․․․" class="my-2 user_search" value="{{ $post->head_doctor_id }}"/>
            ...
            <li class="list-group-item">
                ...
                <em class="error text-danger" data-input="" value="{{ $post->pharmacy_manager_id }}"></em>
            </li>
            ...
            <li class="list-group-item">
                ...
                placeholder="Ընտրել ուղեգրող բժիշկին․․․" class="my-2 user_search"/>
                <em class="error text-danger" data-input="" value="{{ $post->chief_nurse_id }}"></em>
            </li>
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-md-6">
                        <x-forms.text-field name="started_destroying_date" validationType="ajax" type="date"
                            value="{{ $post->started_destroying_date }}" label="" />
                    </div>
                </div>
            </li>
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-md-6">
                        <x-forms.text-field name="finished_destroying_date" validationType="ajax" type="date"
                            value="{{ $post->finished_destroying_date }}" label="" />
                    </div>
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{ $post->dose }}" label="Քանակը՝/տառերով և թվերով/
                    " />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="{{ $post->dose_patients }}" label="Թմրամիջոցներ և հոգեմետ դեղեր ստացած հիվանդների քանակը,
