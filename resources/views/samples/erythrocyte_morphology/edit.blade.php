...
<div class="container">
    <form class="ajax-submitable dont-reset" action="{{route('samples.patients.erythrocyte-morphology.update', ['patient'=> $patient, 'erythrocyte_morphology'=> $em])}}" method="POST">
        @csrf
        <ul class="list-group">
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->anocytosis_comment}}" label="Анозицитоз ( макроцитозы,  микроциты, мегалоциты)" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->poikilocytosis_comment}}" label="Пойкилоцитоз" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->basophil_comment}}" label="Базофильная зернистость" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->polychromatophilia_comment}}" label="Полихроматофолия" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->jolie_bodies_comment}}" label="Тельца Жолли, кольца Кебота" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->erythronormoblasts_comment}}" label="Эритро-нормобласты (из 100 лейкоцитов)" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->mesaloblasts_comment}}" label="Мегалобласты" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->nuclear_over_segmentation_comment}}" label="Гиперсегментация ядер" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div>
                        ...
                        value="{{$em->toxic_fatification_comment}}" label="Токсогенная зернистость" />
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            ...
                            value="{{$em->analysis_response_date}}" label="" />
                        </div>
                    </div>
                </li>
                ...
                <li class="list-group-item">
                        ...
                        value="{{$em->attending_doctor->full_name}}" />
                </li>
