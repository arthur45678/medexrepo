...
<div class="container">
    <form class="ajax-submitable" action="{{route('samples.patients.awareness-sheet.store', ['patient'=> $patient])}}" method="POST">
        @csrf
        <ul class="list-group">
                <li class="list-group-item">
                        ...
                        <div class="col-md-10">
                            <x-forms.text-field name="first_date" validation-type="ajax" type="datetime-local"
                            value="" label="" />
                        </div>
                    </div>
                </li>
                ...
                <li class="list-group-item">
                    ...
                    <div class="col-mt-2">
                        <x-forms.checkbox-radio pos="align" id="wheelchair-radio1" value="1" name="accept" label="համաձայն եմ"/>
                        <x-forms.checkbox-radio pos="align" id="wheelchair-radio2" value="0" name="accept" label="հրաժարվում եմ"/>
                        @error('by_wheelchair')
                ...
                <li class="list-group-item">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-10">
                            <x-forms.text-field name="second_date" validation-type="ajax" type="datetime-local"
                            value="" label="" />
                        </div>
                    </div>
                </li>
                <li class="list-group-item">
                        ...
                        <x-forms.magic-search hidden-id="cvc_department_head_id" hidden-name="department_head_id"
                        placeholder="Ընտրել բուժող բժիշկին․․․" class="magic-search ajax my-2" data-list-name="users"
                        value="" />
                </li>
                <li class="list-group-item">
                        <strong>Տնօրեն</strong>
                        <x-forms.magic-search hidden-id="cvc_director_id" hidden-name="_id"
                        placeholder="Ընտրել բուժող բժիշկին․․․" class="magic-search ajax my-2" data-list-name="users"
                        value="" />
                </li>
