...
<div class="container">
    <form class="ajax-submitable" action="{{route('samples.patients.biochemical-lab-n8.store', ['patient'=> $patient])}}" method="POST">
        @csrf
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="Ընդհանուր սպիտակուց  նորմա - 65 – 85 գ/լ" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="Ընդհանուր բիլիռուբին նորմա - 8.55 – 20.5 մկմոլ/լ" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="կապված բիլիռուբին նորմա - 0 – 5.1 մկմոլ/լ" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="Թիմոլային փորձ նորմա - 0 – 5 միավոր" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="Միզանյութ նորմա - 2.5 – 8.3 մմոլ/լ" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="Գլյուկոզ նորմա - 6.4 մմոլ/լ" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="Ասպարտատամինոտրասֆերազա (ԱՍՏ) նորմա - մինչև 37 Մ/լ" />
                </div>
            </li>
            ...
            <li class="list-group-item">
                <div class="mt-2">
                    ...
                    value="" label="Ալանինամինոտրանսֆերազա(ԱԼՏ) նորմա - մինչև 42 Մ/լ" />
                </div>
            </li>
