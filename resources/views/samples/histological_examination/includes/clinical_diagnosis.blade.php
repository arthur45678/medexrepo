@php
    ...
    $diagnosis_action_route = $included_action_route ?? route("samples.patients.histological-examination.diagnoses");
...
<form action='{{ $diagnosis_action_route }}' class="ss ajax-submitable dont-reset" method="POST" id='{{$insert_form_id}}'>
    @method($method)
    @csrf
