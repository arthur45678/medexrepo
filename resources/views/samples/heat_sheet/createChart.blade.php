...
<div class="container">
    <form class="ajax-submitable" action="{{ route('samples.heat_sheet.heat_sheet_charts.store', [$heatSheet]) }}" method="POST">
        @csrf
        <ul class="list-group">
            ...
            <li class="list-group-item">
                ...
                <select  name="day_time_period"  class="form-control my-2" validationType="ajax">
                    <option value="A">Առավոտ</option>
                    <option value="E">Երեկո</option>
