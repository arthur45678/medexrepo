...
<form class="ajax-submitable dont-reset" action="{{ route('samples.patients.radiation-treatment-card.updateRadiationFinalData', [$card->treatment_final_data->id]) }}" method="POST">
    @csrf
    @method('put')
