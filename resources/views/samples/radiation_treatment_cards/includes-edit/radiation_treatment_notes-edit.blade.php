...
@endphp
<form class="ajax-submitable dont-reset" action="{{ route('samples.patients.radiation-treatment-card.updateadiationTreatmentNotes', [$card->treatment_notes->id]) }}" method="POST">
    @method('put')
    @csrf
    <ul class="list-group">
