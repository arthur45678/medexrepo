...
<form class="ajax-submitable dont-reset" method="post" action="{{ route('samples.patients.radiation-treatment-card.updateRadiationTreatmentPlan',[$card->treatment_plan->id]) }}">
    @csrf
    @method('put')
