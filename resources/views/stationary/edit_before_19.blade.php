            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="input-group align-items-center">
                                <input disabled class="form-control col-4" type="text" value="{{$format}}">
        ...
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <strong>
                            <span class="badge badge-light mr-1">11.0.դ)</span>
                            Նշում է տուբերկուլյոզին բնորոշ գանգատներ՝
                        </strong>
                    </div>
                    <div class="col-md-7">
                        <x-forms.checkbox-radio pos="align" id="has_tuber-radio1" value="1" form="update_11_17"
                            old-default="{{$stationary_array['has_tuberculosis_complaints']}}" name="has_tuberculosis_complaints"
                            label="նշում է" />
                        <x-forms.checkbox-radio pos="align" id="has_tuber-radio2" value="0" form="update_11_17"
                            old-default="{{$stationary_array['has_tuberculosis_complaints']}}" name="has_tuberculosis_complaints"
                            label="չի նշում" />
                    </div>
                </div>
                ...
                <li class="list-group-item">
                    ...
                    <div class="form-row align-items-center my-2 mx-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <x-forms.magic-search class="doctors-search mt-1" placeholder="ընտրել բաժանմունքի վարիչին․․․"
