...
@section('card-header')
    ...
    <div class="card-header-actions">
        <a href="{{ route("admin.stage-list.create") }}" class="btn btn-primary float-right mr-4" type="button" target="_blank">
            <x-svg icon="cui-plus" />
            ավելացնել նորը
        </a>
    </div>
    ...
    <table class="table table-md table-hover table-responsive table-cursor datatable-default" style="width:100%;">
        ...
        @foreach ($lists as $list)
            <tr >
                ...
                @endif
                <td>
                    <form method="POST" action="{{route('admin.stage-list.update',$list->id)}}" class="d-inline">
                        @csrf
                        @method("put")
                    ...
                    <a href="{{route('admin.stage-list.edit',$list->id)}}">
