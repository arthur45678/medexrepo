...
@section('card-header')
    <h4>Հիվանդության ելքեր</h4>
    <div class="card-header-actions">
        <a href="{{ route("admin.exit-lists.create") }}" class="btn btn-primary float-right mr-4" type="button" target="_blank">
            <x-svg icon="cui-plus" />
            ավելացնել նորը
        </a>
    </div>
    ...
    <table class="table table-md table-hover table-responsive table-cursor datatable-default" style="width:100%;">
        ...
        @foreach ($lists as $k=>$list)
            <tr >
                ...
                @endif
                <td>
                    <form method="POST" action="{{route('admin.exit-lists.update',$list->id)}}" class="d-inline">
                        @csrf
                        @method("put")
                    ...
                    <a href="{{route('admin.exit-lists.edit',$list->id)}}">
