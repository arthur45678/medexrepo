...
<div class="container">
    <form class="ajax-submitable" action="{{route('otherSamples.ptc.update',$procurement->id)}}" method="POST">
        @csrf
        @method('put')
        <ul class="list-group">
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="textarea" name="invitation_quota_number" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['invitation_quota_number']}}" label="Հրավերով նախատեսված չափաբաժնի համարը" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="textarea" name="procurement_plan_passcode" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['procurement_plan_passcode']}}" label="Գնումների պլանով նախատեսված միջանցիկ ծածկագիրը ըստ ԳՄԱ դասկարգման (CPV)" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="textarea" name="name_and_trademark" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['name_and_trademark']}}" label="Անվանումը և ապրանքային նշանը" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="textarea" name="manufacturer_name_and_country" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['manufacturer_name_and_country']}}" label="Արտադրողի անվանումը և ծագման երկիրը" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="textarea" name="technical_specifications" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['technical_specifications']}}" label="Տեխնիկական բնութագիրը" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="textarea" name="measurement_unit" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['measurement_unit']}}" label="Չափման միավորը" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="number" name="unit_price" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['unit_price']}}" label="Միավոր գինը ՀՀ դրամ" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="number" name="total_price" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['total_price']}}" label="Ընդհանուր գինը ՀՀ դրամ" />
                    </div>
            </li>
            <li class="list-group-item">
                    <div>
                        <x-forms.text-field type="number" name="total_quantity" validation-type="ajax" placeholder="լրացման ազատ դաշտ․․․"
                        value="{{$procurement['total_quantity']}}" label="Ընդհանուր քանակը" />
                    </div>
            </li>
