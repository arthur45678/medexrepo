(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/assets/calendar/js/evo-calendar"],{

/***/ "./resources/js/calendar/evo-calendar.js":
/*!***********************************************!*\
  !*** ./resources/js/calendar/evo-calendar.js ***!
  \***********************************************/
...
(function (factory) {
      ...
      _.initials = {
        ...
        dates: {
          en: {
            ...
            daysShort: ["Կիր", "Երկ", "Երք", "Չոր", "Հինգ", "Ուրբ", "Շաբ"],
            daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"],
            months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
            monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
            // noEventForToday: "Գրանցումներ չկան",
            noEventForToday: "",
            noEventForThisDay: "",
            // noEventForThisDay: "Գրանցումներ չկան",
  ...
  EvoCalendar.prototype.buildTheBones = function () {
    ...
    if (!_.$elements.calendarEl.html()) {
      var markup;
      var mnths = ["Հունվար", "Փետրվար", "Մարտ", "Ապրիլ", "Մայիս", "Հունիս", "Հուլիս", "Օգոստոս", "Սեպտեմբեր", "Հոկտեմբեր", "Նոյեմբեր", "Դեկտեմբեր"]; // --- BUILDING MARKUP BEGINS --- //
      // sidebar
      ...
      for (var i = 0, j = 0; i < _.$label.months.length, j < mnths.length; i++, j++) {
        // markup += '<li class="month" role="button" data-month-val="'+i+'">'+_.initials.dates[_.options.language].months[i]+'</li>';
        markup += '<li class="month" role="button" data-month-val="' + i + '">' + mnths[j] + '</li>';
      }

      markup += '</ul>';
      markup += '</div></div>'; // inner

      markup += '<div class="calendar-inner">' + '<table class="calendar-table">' + '<tr><th colspan="7" class="name_info"></th></tr>' + '<tr class="calendar-header">';
      ...
      markup += '</tr></table>' + '<button class="plus" onclick="modalToggle()"></div></button>'; // events

      markup += '<div class="calendar-events">' + '<div class="event-header"><p></p></div>' + '<div class="event-list" id="event_result"></div>' + '</div>'; // --- Finally, build it now! --- //
  ...
  EvoCalendar.prototype.buildEventList = function () {
    ...
    var mnths = ["Հունվար", "Փետրվար", "Մարտ", "Ապրիլ", "Մայիս", "Հունիս", "Հուլիս", "Օգոստոս", "Սեպտեմբեր", "Հոկտեմբեր", "Նոյեմբեր", "Դեկտեմբեր"];
    _.$active.events = []; // Event date

    var title = _.formatDate(_.$active.date, mnths[new Date(_.$active.date).getMonth()] + " " + _.options.eventHeaderFormat1, _.options.language);
  ...
  EvoCalendar.prototype.buildCalendar = function () {
    ...
    title = _.formatDate(new Date(_.$label.months[_.$active.month] + '  ' + _.$active.year), _.options.titleFormat, _.options.language);

    _.$elements.innerEl.find('.calendar-table th').text(mnths[_.$active.month]);
    ...
    for (var i = 0; i < 9; i++) {
      ...
      for (var j = 0; j < _.$label.days.length; j++) {
        ...
        if (day <= _.monthLength && (i > 0 || j >= _.startingDay)) {
          ...
          markup += '<div onclick="ajax(this),plus(this)" class="day" role="button" data-date-val="' + thisDay + '">' + day + '</div>';
          day++;
        } else {
          markup += '<td>';
        }
  ...
  ****************/
  ...
  $.fn.evoCalendar = function () {
    ...
    for (i = 0; i < l; i++) {
      if (_typeof(opt) == 'object' || typeof opt == 'undefined') _[i].evoCalendar = new EvoCalendar(_[i], opt);else ret = _[i].evoCalendar[opt].apply(_[i].evoCalendar, args);
...
/***/ 5:
/*!*****************************************************!*\
  !*** multi ./resources/js/calendar/evo-calendar.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OpenServer\domains\medexrepo\resources\js\calendar\evo-calendar.js */"./resources/js/calendar/evo-calendar.js");


/***/ })

},[[5,"/js/components/manifest","/js/components/vendor"]]]);